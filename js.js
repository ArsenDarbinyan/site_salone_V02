...
const masters = [
    ...
    },
    {
        ...
        servicePrices: [
            ...
            {
                name: { hy: ' Եղունգների լիցք', ru: 'Наращивание ногтей', en: 'Nail extension' },
                price: { hy: '12000 - 15000 դրամ', ru: '12000 - 15000 драм', en: '12000 - 15000 AMD' }
            }
        ]
    },
    {
...
async function toggleServiceCard(serviceId) {
    ...
    if (isExpanding) {
        ...
        setTimeout(() => scrollServiceCardIntoView(card), 30); // здесь должно быть  700  не менять эту цыфру  
    }
}
