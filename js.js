const translations = {
    ...
    ru: {
        ...
        address: 'Ереван, проспект Комитаса, 60/2, Yerevan City',
...
//             ru: 'Стрижка и уход за волосами',
//             en: 'Hair styling and care'
//         },
//         items: [
//             {
//                 name: { hy: 'վարսահարդարում', ru: 'Женская стрижка', en: "Women's haircut" },
//                 price: { hy: '2000 - 5000 դրամ', ru: '15000 - 25000 драм', en: '15000 - 25000 AMD' }
//             },


//             {
//                 name: { hy: 'կտրվածք', ru: 'Женская стрижка', en: "Women's haircut" },
//                 price: { hy: '3000 - 5000 դրամ', ru: '15000 - 25000 драм', en: '15000 - 25000 AMD' }
//             },
//             {
//                 name: { hy: 'ներկում', ru: 'Женская стрижка', en: "Women's haircut" },
//                 price: { hy: '2000 - 5000 դրամ', ru: '15000 - 25000 драм', en: '15000 - 25000 AMD' }
//             },
//             {
//                 name: { hy: 'ալիքներ', ru: 'Женская стрижка', en: "Women's haircut" },
//                 price: { hy: '5000 - 15000 դրամ', ru: '15000 - 25000 драм', en: '15000 - 25000 AMD' }
//             }
...
//     //     name: 'Վարսահարդարում',
//     //     icon: 'fa-scissors',
//     //     description: 'Վարսահարդարում և խնամք',
//     //     items: [
//     //         { name: 'Կանանց Վարսահարդարում', price: '15000 - 25000 դրամ' },
//     //         { name: 'Տղամարդկանց Վարսահարդարում', price: '8000 - 15000 դրամ' },
//     //         { name: 'Դեկորատիվ Վարսահարդարում', price: '20000 - 40000 դրամ' },
//     //         { name: 'Վարսերի ներկում', price: '12000 - 30000 դրամ' },
//     //         { name: 'Բալայաժ', price: '25000 - 50000 դրամ' },
//     //         { name: 'Կերատինային բուժում', price: '40000 - 80000 դրամ' }
//     //     ]
//     // },
//     {
//         id: 2,
...
//             ru: 'Профессиональные услуги маникюра',
//             en: 'Professional manicure services'
//         },
//         items: [
//             {
//                 name: { hy: 'մատնահարդարում', ru: 'Классический маникюр', en: 'Classic manicure' },
//                 price: { hy: '3000 - 5000 դրամ', ru: '8000 - 12000 драм', en: '8000 - 12000 AMD' }
//             },
//             {
//                 name: { hy: 'Գելային մատնահարդարում', ru: 'Маникюр с гель-лаком', en: 'Gel polish manicure' },
//                 price: { hy: '6000 - 8000 դրամ', ru: '12000 - 18000 драм', en: '12000 - 18000 AMD' }
//             },
//             {
//                 name: { hy: 'Lիցք', ru: 'Маникюр шеллак', en: 'Shellac manicure' },
//                 price: { hy: '8000 - 15000 դրամ', ru: '10000 - 15000 драм', en: '10000 - 15000 AMD' }
//             },
//             {
//                 name: { hy: 'Տղամարդկանց մատնահարդարում', ru: 'Мужской маникюр', en: "Men's manicure" },
//                 price: { hy: '5000 - 10000 դրամ', ru: '5000 - 8000 драм', en: '5000 - 8000 AMD' }
//             },
//             {
//                 name: { hy: 'SPA մատնահարդարում', ru: 'SPA маникюр', en: 'SPA manicure' },
//                 price: { hy: '3000 - 5000 դրամ', ru: '15000 - 20000 драм', en: '15000 - 20000 AMD' }
//             }
//         ]
//     },
//     {
...
//             ru: 'Уход за ногами и расслабление',
//             en: 'Foot care and relaxation'
//         },
//         items: [
//             {
//                 name: { hy: 'Ոտնահարդարում', ru: 'Классический педикюр', en: 'Classic pedicure' },
//                 price: { hy: '8000 - 10000 դրամ', ru: '10000 - 15000 драм', en: '10000 - 15000 AMD' }
//             },
//             {
//                 name: { hy: 'Գել լաքով ոտնահարդարում', ru: 'Педикюр с гель-лаком', en: 'Gel polish pedicure' },
//                 price: { hy: '10000 - 15000 դրամ', ru: '15000 - 22000 драм', en: '15000 - 22000 AMD' }
//             },
//             {
//                 name: { hy: 'SPA ոտնահարդարում', ru: 'SPA педикюр', en: 'SPA pedicure' },
//                 price: { hy: '5000 դրամ', ru: '18000 - 25000 драм', en: '18000 - 25000 AMD' }
//             },
...
//         items: [
//             {
//                 name: { hy: 'Հոնքերի ձևավորեում', ru: 'Свадебный макияж', en: 'Bridal makeup' },
//                 price: { hy: '2000 - 5000 դրամ', ru: '25000 - 50000 драм', en: '25000 - 50000 AMD' }
//             },
//             {
//                 name: { hy: 'Ականջի դակում', ru: 'Свадебный макияж', en: 'Bridal makeup' },
//                 price: { hy: '4000 դրամ', ru: '25000 - 50000 драм', en: '25000 - 50000 AMD' }
//             },
//             {
//                 name: { hy: 'Թարթիչների լիցք', ru: 'Свадебный макияж', en: 'Bridal makeup' },
//                 price: { hy: '10000 - 20000 դրամ', ru: '25000 - 50000 драм', en: '25000 - 50000 AMD' }
//             },


//             {
//                 name: { hy: 'Դիմահարդարում', ru: 'Дневной макияж', en: 'Day makeup' },
//                 price: { hy: '8000 - 20000 դրամ', ru: '10000 - 15000 драм', en: '10000 - 15000 AMD' }
//             }
...
//             ru: 'Современное удаление волос',
//             en: 'Modern hair removal'
//         },
//         items: [
//             {
//                 name: { hy: 'Էլոս մազահեռացում', ru: 'Лазерная эпиляция', en: 'Laser hair removal' },
//                 price: { hy: '3000 - 25000 դրամ', ru: '15000 - 40000 драм', en: '15000 - 40000 AMD' }
//             },
//             {
//                 name: { hy: 'Ասեղային էպիլյացիա', ru: 'Эпиляция твердым воском', en: 'Hard wax depilation' },
//                 price: { hy: '5000 դրամ', ru: '5000 - 15000 драм', en: '5000 - 15000 AMD' }
//             },
//             {
//                 name: { hy: 'Ոսկով մազահեռացում', ru: 'Шугаринг', en: 'Sugaring' },
//                 price: { hy: '3000 - 20000 դրամ', ru: '5000 - 20000 драм', en: '5000 - 20000 AMD' }
//             },
...
//             ru: 'Профессиональный уход за мужскими волосами и бородой',
//             en: 'Professional men\'s hair and beard care'
//         },
//         items: [
//             {
//                 name: { hy: 'Մազերի կտրվածք', ru: 'Мужская стрижка', en: 'Haircut' },
//                 price: { hy: '3000 - 4000 դրամ', ru: '5000 - 8000 драм', en: '5000 - 8000 AMD' }
//             },
...
//                 price: { hy: '4000 դրամ', ru: '4000 - 7000 драм', en: '4000 - 7000 AMD' }
//             },
//             {
//                 name: { hy: 'Չոր սափրում', ru: 'Влажное бритье', en: 'Wet shave' },
//                 price: { hy: '3000 - 4000 դրամ', ru: '4000 - 7000 драм', en: '4000 - 7000 AMD' }
//             },
//             {
//                 name: { hy: 'Ներկում', ru: 'Влажное бритье', en: 'Wet shave' },
//                 price: { hy: '4000 - 5000 դրամ', ru: '4000 - 7000 драм', en: '4000 - 7000 AMD' }
//             },
//             {
//                 name: { hy: 'Ոսկով մազահեռացում', ru: 'Влажное бритье', en: 'Wet shave' },
//                 price: { hy: '1000 - 5000 դրամ', ru: '4000 - 7000 драм', en: '4000 - 7000 AMD' }
//             }
...
//     specialization: {
//         hy: 'Վարսահարդար',
//         ru: 'Мастер маникюра и парикмахер',
//         en: 'Manicurist and Hairdresser'
//     },
//     contacts: {
//         phone: '+37498201662',
//         telegram: 'dianagevorgyan_keratinprof'
//     },
//     servicePrices: [
//         {
...
//     specialization: {
//         hy: 'Վարսահարդար',
//         ru: 'Парикмахер и барбер',
//         en: 'Hairdresser and Barber'
//     },
//     contacts: {
//         phone: '+37498201662',
//         telegram: 'dianagevorgyan_keratinprof'
...
//                 price: { hy: '40 - 5000 դրամ', ru: '40 - 5000 драм', en: '40 - 5000 AMD' }
//             }
//         ]
//     },
//     {
...
//     specialization: {
//         hy: 'Մատնահարդար և Ոտնահարդար',
//         ru: 'Мастер маникюра и педикюра',
//         en: 'Manicurist and Pedicurist'
//     },
//     contacts: {
//         phone: '+37498201662',
//         telegram: 'dianagevorgyan_keratinprof'
...
//         servicePrices: [
//             {
//                 name: { hy: 'Կանանց վարսահարդարում', ru: 'Женская стрижка', en: "Women's haircut" },
//                 price: { hy: '16000 - 26000 դրամ', ru: '16000 - 26000 драм', en: '16000 - 26000 AMD' }
//             },
//             {
//                 name: { hy: 'Մազերի կտրվածք', ru: 'Стрижка волос', en: 'Haircut' },
//                 price: { hy: '5000 - 8000 դրամ', ru: '5000 - 8000 драм', en: '5000 - 8000 AMD' }
//             },
//             {
//                 name: { hy: 'Մորուքի խնամք', ru: 'Уход за бородой', en: 'Beard care' },
//                 price: { hy: '3000 - 6000 դրամ', ru: '3000 - 6000 драм', en: '3000 - 6000 AMD' }
//             }
//         ]
//     },
...
//     {
//         id: 9,
//         name: { hy: 'Ամալյա Խաչատրյան', ru: 'Амалия Хачатрян', en: 'Amalia Khachatryan' },
...
//                 price: { hy: '120000 դրամ', ru: '120000 драм', en: '120000 AMD' }
//             },
//             {
//                 name: { hy: 'Ոտնաթաթի հարդարում', ru: 'Обработка стоп', en: 'Foot treatment' },
//                 price: { hy: '4000 - 5000 դրամ', ru: '4000 - 5000 драм', en: '4000 - 5000 AMD' }
...
function renderServices(currentLang = 'hy') {
    ...
    grid.innerHTML = services.map(service => `
        <div class="service-card fade-in" data-service-id="${service.id}" onclick="toggleServiceCard(${service.id})">
...
function renderMasters(filterServiceId = null, currentLang = 'hy') {
    ...
    grid.innerHTML = filteredMasters.map(master => {
        ...
        if (hasPhone || hasTelegram) {
            // Заранее очищаем номер телефона от лишних символов
            const cleanPhone = hasPhone ? master.contacts.phone.replace(/[^0-9+]/g, '') : '';

            contactsHtml = `
            <div class="booking-contacts" id="contacts-${master.id}">
                ${hasPhone ? `
                <a href="tel:${cleanPhone}" class="contact-link call-btn" onclick="event.stopPropagation();">
                ...
                ${hasTelegram ? `
                <a href="#" class="contact-link tg-btn" onclick="event.stopPropagation(); handleTelegramClick('${master.contacts.telegram}'); return false;">
        ...
        <div class="master-card fade-in ${isExpert ? 'expert-master' : ''}" data-master-id="${master.id}" onclick="toggleMasterCard(${master.id})">
            ...
            <div class="master-card-content">
                <img src="${master.photo}" alt="${typeof master.name === 'object' ? (master.name[currentLang] || master.name['hy']) : master.name}" class="master-photo" 
                     style="${isExpert ? 'border-color: #FFD700;' : ''}"
                     onerror="this.src='https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop'">
                ${isExpert ? '<div style="margin-bottom: 5px;"><span class="expert-badge"><i class="fas fa-crown"></i> Expert</span></div>' : ''}
            ...
            <div class="master-details">
                ${master.servicePrices.map(sp => `
                    <div class="master-service-item">
                        <!-- Выводим названия процедура мастера и цены под язык -->
...
async function toggleMasterCard(masterId) {
    ...
    await runExpandableCardToggle(masterToggleGenRef, '.master-card', card, {
        ...
        btn: card.querySelector('.master-expand-btn'),
...
//     // tel: ссылки открываются через window.location.href на мобильных
//     // Telegram.WebApp.openLink НЕ поддерживает tel: схему
